...
def main():
    ...
    if st.button("Get Feedback"):
        ...
        prompt = f"""
As a debate teacher, you are tasked with generating constructive feedback for a student who has written an argument following the CWSI model. 
...
Use the following rubric to analyze the student writing:
